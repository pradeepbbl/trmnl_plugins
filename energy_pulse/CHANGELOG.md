...
- Added the United States (New York) as a supported market, with 11
  selectable load zones (Capital District, Central New York, Dunwoodie,
  Genesee, Hudson Valley, Long Island, Millwood, Mohawk Valley, New York
  City, North Country, Western New York). Default: New York City.
...
[Unreleased]: https://github.com/pradeepbbl/trmnl_plugins/compare/energy_pulse-v1.0.3...HEAD
[1.0.3]: https://github.com/pradeepbbl/trmnl_plugins/releases/tag/energy_pulse-v1.0.3
